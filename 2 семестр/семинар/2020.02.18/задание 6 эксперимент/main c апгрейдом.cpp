//программа, дополненная файловыми вводом и выводом
//Если файла нет в директории, то программа создаст новый, так как он будет пустым, результат окажется no
//сборка под линукс в папке 2020.02.11
#include <iostream>
#include <stack>
#include <cmath>
#include <cstring>

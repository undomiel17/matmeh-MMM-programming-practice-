//несмотря на то, что у меня 64-разрядная система, указатель занимает 4 байта, так что структура выравнивается по наибольшему элементу
//в моеём случае это double. поставила на первое место для простоты. пробовала меня эелементы структуры местами, всё работает
#include <iostream>
#include <locale>
#include <cmath>
using namespace std;

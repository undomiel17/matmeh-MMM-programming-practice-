//Реализовать шаблон Stack с операцией многократного извлечения(multipop) выписывающей промежуточные значения. Сделать специализацию шаблона для логического типа. 
